...
var timeDiff = 0;
var firstLight = true;
var background = "linear-gradient(#000, #000)";
var words = [];
...
function start(refresh = false){
  ...
  setTimeout(lightning,4100);

  words.push(new Word("Not working together"));
  words.push(new Word("Not having lunch together"));
  words.push(new Word("Not Attending networking events"));
  words.push(new Word("Not Celebrate work milestones"));
  words.push(new Word("No brainstorming session"));
  words.push(new Word("No funny team-buildings"));
  words.push(new Word("Not Sharing industry news"));
  words.push(new Word("Not asking for raises."));
